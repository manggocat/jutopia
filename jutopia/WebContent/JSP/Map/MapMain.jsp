...
<body>
	...
	<div class="map_wrap" >
		<div id="map" style="width: 50%; height: 70%; position: relative; overflow: hidden;margin-left: 40%;"></div>
	
		<div id="menu_wrap" class="bg_white" style="height: 65%;margin-left:15%;"  >
			<div class="option">
				<div>
