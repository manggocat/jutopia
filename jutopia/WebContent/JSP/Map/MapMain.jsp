...
<body>
	...
	<div class="container well"
		style="width: 90%; height: 500px; opacity: 0.7; position: absolute; align: center; margin-left: 70px;"></div>
	<br>
	<div style="position: relative;">
		<div align="center">
			<input type="button" name="road_address" value="도로명 주소"
				id="road_address" />&nbsp;&nbsp; <input type="button"
				name="address" value="지번 주소" id="address" />
	...
	<table align="center">
		...
		<tr>
			<td><font style="color: white;">서울시 강남구 태해란로 103길 17정석빌딩
					&nbsp;&nbsp; 대표이사 : 서효진 &nbsp;&nbsp; 사업자등록번호 : 138-81-05876
					&nbsp;&nbsp; 통신판매업 신고번호 : 제2011-서울강남-02008호</td>
		</tr>
		<tr>
			<td><font style="color: white;">문의전화(평일 09:00~18:00) :
					1566-7727 &nbsp;&nbsp; (유료)이메일 : meloninformation@iloen.com
					&nbsp;&nbsp;© 2016. LOEN Entertainment, Inc. ALL RIGHTS RESERVED.</td>
		</tr>
