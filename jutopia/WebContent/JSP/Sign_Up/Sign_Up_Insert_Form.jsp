...
<script type="text/javascript">
   ...
   function checkIt() { //사용자가 입력폼에 입력한 상황을 체크
		...
		if (!phone_fileter.test(sign_up_tel.value) ) {
    		alert(sign_up_tel.value);
	    	alert("양식을 지켜서 입력해 주세요.");
	    	return false;
    	} 
         
		window.open("JSP/Sign_Up/Sign_Up_Insert_Popup.jsp?", "회원가입 완료", 
    ...
    function openConfirmid(userinfo) {
        ...
        url = "JSP/Sign_Up/Sign_Up_confirmId.jsp?email1=" + userinfo.text_mail_1.value + "&email2=" + userinfo.text_mail_2.value ;
...
<nav class="navi">
<br>
<form method="get" action="Sign_Up_Insert_Pro.do" name="userinfo" onSubmit="return checkIt()" >
