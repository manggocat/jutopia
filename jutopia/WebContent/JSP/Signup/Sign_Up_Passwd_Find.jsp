...
<table class="pass_table" border="1" >
	...
	<tr>
		<td colspan="2"><input type="submit" value="인증번호 보내기"  
	...
	<tr>
		<td colspan="2" rowspan="2"><input type="button" value="닫기" onclick="exit()" 
		style="color:#000;font:12px/15px 굴림, Gulim, sans-serif; margin-left: 340px; margin-top: 30px;" /></td>
