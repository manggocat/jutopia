...
public class SignupVO implements Serializable {
	...
	public String getStr_User_Tel() {
		return str_User_Tel;
	}

	public void setStr_User_Tel(String str_User_Tel) {
		this.str_User_Tel = str_User_Tel;
	}

	public String getStr_Manager() {
		return str_Manager;
	}

	public void setStr_Manager(String str_Manager) {
		this.str_Manager = str_Manager;
	}
